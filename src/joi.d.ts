...
declare module 'joi' {
  ...
  export type TypeToSchema<T> = T extends 'any'
    ? AnySchema<'any'>
    : T extends 'array'
      ? ArraySchema
      : T extends 'boolean'
  ...
  export interface AnySchema<TSCHEMA extends Types = 'any'> extends JoiObject {
    schemaType?: TSCHEMA;
  ...
  export interface StringSchema<REQ extends boolean = false>
    extends AnySchema<'string'> {
    /**
  ...
  export interface ObjectSchema<T = any> extends AnySchema {
     ...
     */
    keys<K extends SchemaMap>(schema: K): ObjectSchema<typeof schema>;
  ...
  export function reach<T extends Schema>(
    schema: ObjectSchema,
    path: string,
  ): T;
